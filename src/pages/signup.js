...
function SignUp({ onClose }) {
  ...
  return (
    <div className="modal">
      <div className=" modal-style">
        ...
        <img src={ SignUplogo} alt="Logo" class="signGoogle" />
       </div>
        ...
        <div className="form-row name-style">
          ...
          <div className="form-row name-style">
            <div className="col-md-3">
              ...
              <select name="countryCode" id="" className="form-inpdeut country-co">
	...
	<optgroup label="Other countries">
		...
		<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
            ...
            <div className="col-md-7">
              <input type="tel" className="form-input mobile-no" placeholder="Mobile No." />
            </div>
          </div>
 ...
 <Link to="/Terms"> <span className="signup-checkbox-link font-style"> Terms of use &</span></Link>                   <Link to="/Privacy"><span className="signup-checkbox-link font-style"> Privacy Policy</span></Link> 
                </span>
              </label>
            </div>
          </div>
